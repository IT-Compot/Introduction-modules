...
>[!IMPORTANT]
>Не скидывайте детям готовые проекты! Если дать ребёнку только код (который зачастую у всех одинаковый и так), но при этом он персонажа и узлы создаст сам, тогда у ребёнка всё равно останется чувство, что это его проект, а не чей-то.
...
2. Найти справа сверху кнопку запуска проекта. ![start](start.gif)
...
- Покажите [презентацию](https://disk.yandex.ru/i/M1WX0__Se0v6Hg).
> [!TIP]
